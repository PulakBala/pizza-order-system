...
//1 = admin / 0 = user
$have_accs_lvl = array("1", "2");
$have_accs_id = array("1");
echo chk_access($eb_user_id, $eb_user_level, $have_accs_lvl, $have_accs_id);

?>
<body>
<section class="ftco-menuu">
                ...
                <div class="login-wrapper wd-500 wd-xs-1000 pd-25 pd-xs-50 bg-white m-auto custom-class">
                  ...
                  <div class="row p-5">
                    ...
                    <div class="col-sm-6 mt-2">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="main_category" name="category_name" onchange="get_category('main_category','1','sub_category')">
                          <option style="color: white;">-- select Category --</option>
                          <?php
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Product Title" name="product_name" >
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="regular price TK" name="product_regular_price" >
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input onclick="calc_pr();" onchange="calc_pr();" type="text" class="form-control" placeholder="Product sale price" name="product_sale_price" id="product_sale_price" >
                      </div><br>

                      <div class="form-group" >
                        <label class="text-dark h6">
                          <h6>Purchase price <span class="sa_ratio" id="sa_ratio">Profit Ratio - 0%</span>
                            <span class="sa_ratio" style="background: #3F51B5;" id="sa_net_ratio">Net Ratio - 0%</span>
                          </h6>
                        </label>
                        <input onclick="calc_pr();" onchange="calc_pr();" type="text" class="form-control" placeholder="Purchase price" name="product_purchase_price" id="product_purchase_price" >
                      </div>

                      <div class="form-group" style="display:none;">
                        <label class="text-dark h6 mt-4">
                          <h6>Product Unit </h6>
                        </label>
                        <div class="input-group p-0">

                          <span class="input-group-text">Unit</span>
                          <input type="text" name="product_unit" value="1" aria-label="Unit" class="form-control" >
                          <select name="product_unit_typ" class="form-control" >
                      ...
                      <div class="form-group" style="display:none;">
                        ...
                        <div class="input-group p-0">
                          ...
                          <input onclick="calc_pr();" onchange="calc_pr();" type="text" id="Self" name="Self" value="0" aria-label="Self" class="form-control" >

                          <span class="input-group-text">Refer</span>
                          <input onclick="calc_pr();" onchange="calc_pr();" type="text" id="Refer" name="Refer" value="0" aria-label="Refer" class="form-control" >

                          <span class="input-group-text">Donate</span>
                          <input onclick="calc_pr();" onchange="calc_pr();" type="text" id="Donate" readonly name="Donate" value="1" aria-label="Donate" class="form-control" >

                          <span class="input-group-text">Platform</span>
                          <input onclick="calc_pr();" onchange="calc_pr();" type="text" id="Platform" readonly name="Platform" value="1" aria-label="Platform" class="form-control" >
                      ...
                      <div class="form-group" style="display:none;">
                        ...
                        <input type="text" class="form-control" placeholder="write a meta title" name="product_meta_title" >
                      </div>

                      <div class="form-group m-auto" style="display:none;">
                      ...
                      <datalist id="browsDlr" style="display:none;">
                        <?php
                      ...
                      <div class="form-group" style="display:none;">
                        ...
                        <input type="number" class="form-control" placeholder="Product stock amount" name="product_stock" >
                      </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label class="text-dark h6">
                          <h6>Add Thumbnail Image <span class="text-secondary p"> (width: 268 X height: 268)</span></h6>
                        </label>
                        <br>
                        <style>
                          article,
                      ...
                      <div class="form-group" style="display:none;">
                        <label class="text-dark h6">
                          <h6>Add Featured Image One <span class="text-secondary p"> (800X800)</span></h6>
                        </label>
                        <br>
                      ...
                      <div class="form-group" style="display:none;">
                        <label class="text-dark h6">
                          <h6>Add Featured Image Two <span class="text-secondary p"> (800X800)</span></h6>
                        </label>
                        <br>
                        <!-- When select image than show this image Code start -->
                        <script class="jsbin" src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                      ...
                      <div class="form-group" style="display:none;">
                        <label class="text-dark h6">
                          <h6>Add Featured Image Three <span class="text-secondary p"> (800X800)</span></h6>
                        </label>
                        <br>
                        <!-- When select image than show this image Code start -->
                        <script class="jsbin" src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
                        ...
                        <img id="imgfour" class="img-sm mt-2 mb-4" style="height:124px !important; display:none; border:1px solid #ddd;padding:2px; border-radius:2px !important;" src="https://img.icons8.com/cotton/64/upload--v1.png" alt="upload--v1" alt="your image" /><br>
                        <input class="form-control" style="display:none;" type='file' onchange="setFeaturedImageThree(this); " name="product_featured_image_three" />
