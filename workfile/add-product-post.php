...
include '../functions.inc.php';
	...
	$_FILES[$imgN]['tmp_name'],$product_thumbnail_image,'../upload/product-image/',$imgresize = '268x262',$imgquality = 95,$watermark ='');
	}}
	...
	$target_file = ''.date('Ymd').'_'.rand(0000,9999);$thumb_image = $target_file.'.'.$imageFileType;									 
	image_thumb($_FILES[$imgN]['name'],$_FILES[$imgN]['size'],$_FILES[$imgN]['type'],
	$_FILES[$imgN]['tmp_name'],$product_featured_image,'../upload/product-image/',$imgresize = '800x800',$imgquality = 99,$watermark ='');
	}}
	...
	$target_file = ''.date('Ymd').'_'.rand(0000,9999);$thumb_image = $target_file.'.'.$imageFileType;									 
	image_thumb($_FILES[$imgN]['name'],$_FILES[$imgN]['size'],$_FILES[$imgN]['type'],
	$_FILES[$imgN]['tmp_name'],$feature_image_two,'../upload/product-image/',$imgresize = '800x800',$imgquality = 99,$watermark ='');
	}}
	...
	$target_file = ''.date('Ymd').'_'.rand(0000,9999);$thumb_image = $target_file.'.'.$imageFileType;									 
	image_thumb($_FILES[$imgN]['name'],$_FILES[$imgN]['size'],$_FILES[$imgN]['type'],
	$_FILES[$imgN]['tmp_name'],$feature_image_three,'../upload/product-image/',$imgresize = '800x800',$imgquality = 99,$watermark ='');
	}}
    // Featured image Two uploaded code End
